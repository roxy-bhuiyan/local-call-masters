    ...
    <footer className="bg-primary text-primary-foreground mt-20">
      <div className="mx-auto max-w-7xl px-4 py-12 grid gap-10 md:grid-cols-4">
        <div>
          ...
          <p className="text-sm opacity-90">Licensed, insured & locally trusted home service experts available 24/7.</p>
      ...
      <div className="border-t border-white/15">
        <div className="mx-auto max-w-7xl px-4 py-5 text-xs opacity-80 flex flex-col md:flex-row gap-2 justify-between">

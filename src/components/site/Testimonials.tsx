    ...
    <section className="py-16 md:py-20 bg-white">
      <div className="mx-auto max-w-7xl px-4">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold">What Our Neighbors Say</h2>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {reviews.map((r) => (
            <div key={r.name} className="bg-secondary rounded-2xl p-6 shadow-[var(--shadow-card)]">
              ...
              <div className="border-t border-border pt-3">
                ...
                <div className="text-xs text-muted-foreground">{r.city} · {r.service}</div>
              </div>
            </div>
          ))}
        </div>

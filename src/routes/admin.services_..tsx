...
export const Route = createFileRoute("/admin/services_/")({
  beforeLoad: ({ params }) => {
...
function ServiceDetail() {
  ...
  // A/B breakdown for this service
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <h1 className="text-2xl font-extrabold text-foreground capitalize">{service.name}</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link to={`/${service.slug}` as string} target="_blank" className="inline-flex items-center gap-1.5 px-3 py-2 rounded-full bg-secondary text-foreground font-semibold text-sm hover:bg-muted">
